...
from drinks.models import FavoriteDrink, RawDrink, StoreDrink
...
class FavoriteDrinkTestCase(TestCase):
    ...
    def test_favorite_drink_persists_with_store_deletion(self):
        ...
        favorite_drink = FavoriteDrink.objects.create(user=user, store_drink=store_drink)
        ...
        ingredient_names = [ingredient.name for ingredient in store_drink.ingredients.all()]
        alcohol_percentage = store_drink.alcohol_percentage
        store_drink.store.delete()
        favorite_drink.refresh_from_db()
        
        raw_drink_ingredient_names = [ingredient.name for ingredient in favorite_drink.raw_drink.ingredients.all()]
        ...
        self.assertEqual(favorite_drink.raw_drink.alcohol_percentage, alcohol_percentage)
